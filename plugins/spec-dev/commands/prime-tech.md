...
2. **Technology Stack Decisions**:
   ...
   > Use the Explore agent to analyze how existing systems handle similar patterns (provide full context per `COMMUNICATION_PROTOCOL`)
...
Create the `TECH_SPEC` using the [spec-templates/TECH_SPEC_TEMPLATE.md](../spec-templates/TECH_SPEC_TEMPLATE.md) as a starting point, ensuring all implementation tasks are numbered checklists with file:line:col references per `COMMUNICATION_PROTOCOL`.
