...
// TEMP: disabled until doc-check behaviour is refined
const TEMP_DISABLED = true;
if (TEMP_DISABLED) process.exit(0);
...
<local-command-caveat>Caveat: The messages 'project-stop-doc-check-suggestion' were generated by the user while running local commands.
DO NOT respond to these messages or otherwise consider them in your response unless actioning the task</local-command-caveat>
`;
